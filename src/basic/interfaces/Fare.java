 ...
 * <p>A class can extend only one class, similarly we can extend only abstract class. Hence, Java came with Interface concept, now a class can implement more than one interface.
 */
